export const textos = {
  ...
  inicio: {
    ...
    subtitulo:
      'Repositório centralizado da informação, que permite uma visão agregada sobre a proteção de dados, com validação das regras de negócio, circuito de submissão, validação, e exportação para Excel e PDF.',
  ...
  campos: {
    ...
    'gestorProjeto.contacto': 'Contacto do GP (email)',
    ...
    politicaPrivacidade: 'Política de Privacidade (caso exista)',
    politicaPrivacidadeAnexos: 'Anexar política de privacidade',
  ...
  totais: {
    ...
    responsavel: 'Responsável de Tratamento',
